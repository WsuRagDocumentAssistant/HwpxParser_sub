...
#
# 사용:
#   python -m tools.run_model            문서 -> 파이프라인 -> 모델 -> 검증 -> 저장
#   python -m tools.run_model --debug    조사용 산출물까지 함께 저장
...
from .build_document_model import main
...
def run(argv: list[str] | None = None) -> int:
    ...
    같은 절차를 두 벌로 두지 않는다. build_summary 가 이 파일과
